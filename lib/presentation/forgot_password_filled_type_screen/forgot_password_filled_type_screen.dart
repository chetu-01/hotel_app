...
/// Section Widget
Widget _buildVerifyButton(BuildContext context) { return CustomElevatedButton(text: "Verify", margin: EdgeInsets.only(left: 24.h, right: 24.h, bottom: 49.v)); } 
